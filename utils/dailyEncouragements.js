const DAILY_ENCOURAGEMENTS = [
    ...
    "🍞 reminder to eat something today!! coding on an empty stomach is NOT recommended.",
    "💤 don't forget to get some sleep tonight! your future self will appreciate it.",
    "🚰 hydration checkpoint!! go drink some water. yes, YOU. i'm watching.",
    ...
    "🍀 remember: bugs are temporary. awesome games are forever.",
    "🤖 i performed today's studio inspection. conclusion: you all are pretty cool.",
    "🧀 i couldn't think of anything motivational today... so here's some emotional support cheese. 🧀",
